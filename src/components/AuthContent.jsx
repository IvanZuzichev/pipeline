...
export function AuthContent() {
  ...
  const handleWorkSphere = () => {
    ...
    return(
      ...
      //     <button onClick={handleWorkSphere} style={{marginBottom: '20px', marginTop: '20px', fontSize: '44px', width: '600px', padding: '25px', backgroundColor: '#3E64B0', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '30px', cursor: 'pointer' }}>Авторизоваться</button>
      //     <button onClick={handleForgotPassword}  style={{marginBottom: '20px', marginTop: '20px', fontSize: '28px', width: '600px', padding: '25px', backgroundColor: 'white',  color: '#3E64B0', padding: '10px 20px', border: 'none', borderRadius: '30px', cursor: 'pointer', textDecoration: 'underline' }}>Забыли пароль?</button>
      //   </div>
      // </div>
    )
}