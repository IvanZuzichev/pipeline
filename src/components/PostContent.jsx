...
export function PostContent() {
    ...
    return(
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
          ...
          <button onClick={handleChange} style={{marginBottom: '80px', marginTop: '20px', fontSize: '44px', width: '600px', padding: '25px', backgroundColor: '#3E64B0', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '30px', cursor: 'pointer' }}>Отправить код</button>
          </div>
      </div>
    )
}