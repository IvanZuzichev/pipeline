  ...
  useEffect(() => {
    ...
    return(
        ...
        <h1 style={{ color: 'rgb(62, 100, 176)', fontSize: '44px', marginBottom: '20px', marginTop: '20px'}}>Введите код из сообщения на почте</h1>
          ...
          <button onClick={handleWorkSpheres} style={{marginBottom: '20px', marginTop: '20px', fontSize: '44px', width: '600px', padding: '25px', backgroundColor: '#3E64B0', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '30px', cursor: 'pointer' }}>Сменить пароль</button>
          </div>
      </div>
    )
}